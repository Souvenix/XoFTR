...
# 6. 语义分割增强配置
_CN.XOFTR.SEMANTIC_ENHANCE = CN()
_CN.XOFTR.SEMANTIC_ENHANCE.USE_SEMANTIC_ENHANCE = True  # 是否启用语义分割增强
_CN.XOFTR.SEMANTIC_ENHANCE.SEMANTIC_WEIGHT = 0.5  # 语义特征融合权重
_CN.XOFTR.SEMANTIC_ENHANCE.FUSION_WEIGHT = 0.3  # 注意力融合权重
_CN.XOFTR.SEMANTIC_ENHANCE.DROPOUT = 0.1  # 注意力dropout
_CN.XOFTR.SEMANTIC_ENHANCE.SEMANTIC_MODEL = 'deeplabv3_resnet50'  # 5. XoFTR Losses
...
# _CN.XOFTR.LINE_FEATURE.ENABLE = True  # 是否启用线特征融合
# _CN.XOFTR.LINE_FEATURE.LINE_LENGTH_THRESH = 20  # 线特征长度阈值
# _CN.XOFTR.LINE_FEATURE.LINE_QUALITY_THRESH = 0.1  # 线特征质量阈值
# _CN.XOFTR.LINE_FEATURE.USE_ADAPTIVE_WEIGHT = True  # 是否使用自适应权重
